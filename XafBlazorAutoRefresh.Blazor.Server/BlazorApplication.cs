...
namespace XafBlazorAutoRefresh.Blazor.Server {
    public partial class XafBlazorAutoRefreshBlazorApplication : BlazorApplication {
        public XafBlazorAutoRefreshBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafBlazorAutoRefreshBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
